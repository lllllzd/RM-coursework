...
targets = [
    ...
    0.13,-0.16,0.03,0;      %3  初始位置  
    0.13,-0.16, 0.023, -10;     %4
    0.13,-0.16, 0.14, -10;  %5
    0.1,-0.1, 0.14, -90;   %6
    0.05, 0.002 ,0.08, -90;  %7
    0.15, 0.002 ,0.08, -90;   %8
...
% velocity
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 112, 1000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 112, 1000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 112, 1000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 112, 1000);

% initial position  最开始待机的位置

write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2800); 
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2800); % gripper open
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2800); % gripper 
pause(0.8);
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2800); % gripper close
pause(0.8);
