...
% 定义目标位置和目标角度的数组
targets = [
    0.1, 0, 0.12, tt;        %1  初始位置  
    0.06, -0.1, 0.07, tt;   %2  方块3上面
    0.07, -0.198, 0.026,tt;  %3  方块3位置 
    0.07, -0.15, 0.1,tt;    %4  
    0.12, -0.12, 0.02, tt;   %5 放下position1
    0.123, -0.123, 0.1, tt;    %6   
    0.1, 0, 0.12, tt;        %7  初始位置 
    0.23, -0.005, 0.032, tt; %8  方块1位置 
    0.22, -0, 0.08, -70;   %9
    0.15, -0.08, 0.1, -5; %10
    0.113, -0.132, 0.08, -5; %11
    0.108, -0.128, 0.052, -10;      %12 second square stacking
    0.115, -0.135, 0.08, -5; %13
    0.15, -0.08, 0.1, -5; %14
    0.15, -0, 0.12, -70;  %15
    0.145, 0.123, 0.1,tt;   %16 
    0.145, 0.145, 0.024,tt;  %17
    0.145, 0.123, 0.1,tt;  %18
    0.145, 0, 0.1,tt;  %19
    0.124, -0.122, 0.072, tt;  %20
    0.1, -0.1, 0.14, tt;  %21
    0.1, 0, 0.12, tt; 
...
pause(0.5);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(20, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(20, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(20, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(20, 4));
pause(0.8);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843); % gripper open
pause(0.5);
