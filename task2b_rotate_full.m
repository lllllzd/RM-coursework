...
targets = [
    ...
    0.216, -0.005, 0.026, -90; %2  方块1位置 
    0.18, -0, 0.05, -90;   %3  夹起
    0.22, -0, 0.07, -20;   %4
    0.216, -0.018, 0.022, -5;   %5  放下位置1
    0.22, -0, 0.07, -20;   %6
    0.18, -0, 0.05, -90;   %7
    %rotation 1%
    ...
    %rotation 2%
   0.1, 0, 0.12, -90;       %8
   0.04, 0.08,0.12,-90;     %9 方块2上去
   0.1, 0.1, 0.1,-90;       %10
   0.146, 0.144, 0.03,-98;   %11 position
   0.125, 0.125, 0.05, -90;  %12
   0.12,0.12,0.12,-30;       %13
   0.124, 0.124, 0.07, -20;  %14
   0.154, 0.13, 0.045,-5;    %15
   0.154, 0.13, 0.025,-5;   %16
   0.154, 0.13, 0.04,-30;  %17
   0.154, 0.13, 0.12, -50; %18
   0.1, 0, 0.12, -90;  %19

   %rotation 3%
   0.1, 0, 0.12, -90;       %20
   0.07, -0.123, 0.1, tt;   %21
   0.07, -0.198, 0.05, -90;  %22
   0.07, -0.198, 0.02,-90;   %23 position
   0.07, -0.198, 0.05, -90;  %24
   0.07, -0.198,0.12,-30;    %25
   0.061, -0.125, 0.07, -20;  %26
   0.059, -0.2, 0.045,-5;    %27
   0.056, -0.2, 0.025,-5;   %28
   0.07, -0.198, 0.04,-30;   %29
   0.07, -0.198, 0.12, -50; %30
   0.1, 0, 0.12, -90;  %31
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600); %close
pause(1);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2840); %开
pause(1);
%移动到第一个方块
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600);
pause(0.3);
...
pause(0.3);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(18, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(18, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(18, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(18, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843);
pause(0.3);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(19, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(19, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(19, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(19, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843);
pause(0.3);


%移动到第一个方块
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(21, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(21, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(21, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(21, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843); % gripper open

%夹起向上
% move 1
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(22, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(22, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(22, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(22, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843); % gripper open
pause(0.5);

%移动到第一个位置放下
% move 2
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(23, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(23, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(23, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(23, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843); % gripper open
pause(0.5);
...
% move 3 向上移动一下
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(24, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(24, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(24, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(24, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600); %close
pause(0.3);


%移动到第一个方块
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(25, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(25, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(25, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(25, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600); % gripper close
pause(0.3);


write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(26, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(26, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(26, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(26, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600); % gripper close
pause(0.3);

write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(27, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(27, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(27, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(27, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600);
pause(0.3);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(28, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(28, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(28, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(28, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 1600);
pause(0.8);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843); % gripper open
pause(1);
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(29, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(29, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(29, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(29, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843);
pause(0.3);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(30, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(30, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(30, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(30, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843);
pause(0.3);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID , 116, theta_vals(31, 1));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, 116, theta_vals(31, 2));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, 116, theta_vals(31, 3));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, 116, theta_vals(31, 4));
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, 116, 2843);
pause(0.3);
